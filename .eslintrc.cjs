...
module.exports = {
	...
	rules: {
		...
		indent: ['error', 'tab', { VariableDeclarator: 0, SwitchCase: 1 }], //	auto fixable enforce consistent indentation
		...
		'jasmine/no-assign-spyon': ['error'], // don't assign spy on to variable
		'jasmine/no-expect-in-setup-teardown': ['error'], // should not check things in tear downs
		...
		'jasmine/no-unsafe-spy': ['error'], // no global spies
