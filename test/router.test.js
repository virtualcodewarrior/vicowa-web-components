...
describe("test router routes match", () => {
	...
	it("should give all parameters for wildcard route", () => {
		...
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { 0: "/base/test/router-test.html" }, url: testUrl, query: undefined, customData: undefined });

		currentContext = undefined;
		testUrl = "router-test.html";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { 0: "router-test.html" }, url: testUrl, query: undefined, customData: undefined });

		currentContext = undefined;
		testUrl = "/base/test/";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { 0: "/base/test/" }, url: testUrl, query: undefined, customData: undefined });
		...
		testUrl = "/base/test/router-test.html";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { 0: "test/router-test.html" }, url: testUrl, query: undefined, customData: undefined });
		...
		testUrl = "/base/test/";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { 0: "test/" }, url: testUrl, query: undefined, customData: undefined });

		currentContext = undefined;
		testUrl = "/base/test/1";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { 0: "test/1" }, url: testUrl, query: undefined, customData: undefined });

		currentContext = undefined;
		testUrl = "/base/testing/bla/test.html";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { 0: "testing/bla/test.html" }, url: testUrl, query: undefined, customData: undefined });
	});
	...
	it("should handle named parameters", () => {
		...
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { test: "cat" }, url: testUrl, query: undefined, customData: undefined });

		currentContext = undefined;
		testUrl = "/base/dogs";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { test: "dogs" }, url: testUrl, query: undefined, customData: undefined });
		...
		testUrl = "/base/testing/bla/test.html";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { name: "test.html" }, url: testUrl, query: undefined, customData: undefined });
		...
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { cats: "waffles", dogs: "oli", birds: "tweety", fish: "tuna", humans: "me" }, url: testUrl, query: undefined, customData: undefined });
		...
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { cats: "waffles", fish: "tuna", humans: "me" }, url: testUrl, query: undefined, customData: undefined });
	...
	it("should handle query strings", () => {
		...
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { test: "number" }, url: testUrl, query: { bla: "5", foo: "bar" }, customData: undefined });
	});
	...
	it("should call first matching route", () => {
		...
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { 0: "path1/path2/path3" }, url: testUrl, query: undefined, customData: undefined });
		...
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { 0: "path2/path3" }, url: testUrl, query: undefined, customData: undefined });
		...
		testUrl = "/path1/path2/path3";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { 0: "path3" }, url: testUrl, query: undefined, customData: undefined });
		...
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { 0: "bla" }, url: testUrl, query: undefined, customData: undefined });
		...
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { birds: "tweety", dogs: "oli", cats: "waffles", 0: "test" }, url: testUrl, query: undefined, customData: undefined });

		currentContext = undefined;
		testUrl = "/tweety/oli/waffles";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { birds: "tweety", dogs: "oli", 0: "waffles" }, url: testUrl, query: undefined, customData: undefined });

		currentContext = undefined;
		testUrl = "/tweety/oli";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { birds: "tweety", 0: "oli" }, url: testUrl, query: undefined, customData: undefined });

		currentContext = undefined;
		testUrl = "/tweety/";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { birds: "tweety", 0: "" }, url: testUrl, query: undefined, customData: undefined });

		currentContext = undefined;
		testUrl = "/tweety";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { 0: "tweety" }, url: testUrl, query: undefined, customData: undefined });
	...
	it("should handle multiple callbacks", () => {
		...
		testUrl = "/waffles/oli/tweety/tuna";
		router.goTo(testUrl);
		expect(currentContext).toEqual({ params: { birds: "tweety", dogs: "oli", cats: "waffles", fish: "tuna" }, url: testUrl, query: undefined, data: "newdata", foo: "bar", customData: undefined });
	});
	...
	it("should call not found handler for mismatched route", () => {
		let currentContext;
		let notFoundContext;
		router.addRoute("/:cats/:dogs/:birds", (context) => { currentContext = context; });

		router.onNotFound = (result) => {
			notFoundContext = result;
		};
